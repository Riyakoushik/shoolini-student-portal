...
export const borrowedBooks: LibraryBook[] = [
  {
    ...
    dueDateStr: "Jun 20, 2026",
    renewalsUsed: 1,
    maxRenewals: 2,
    status: computeStatus(new Date("2026-06-20")),
    finePerDay: 2,
  },
  {
    id: "LB002",
    ...
    dueDateStr: "Jun 25, 2026",
    renewalsUsed: 0,
    maxRenewals: 2,
    status: computeStatus(new Date("2026-06-25")),
    finePerDay: 2,
  },
  {
    id: "LB003",
    ...
    dueDateStr: "Jun 29, 2026",
    renewalsUsed: 0,
    maxRenewals: 2,
    status: computeStatus(new Date("2026-06-29")),
    finePerDay: 2,
  },
  {
    id: "LB004",
    ...
    dueDateStr: "Jun 10, 2026",
    renewalsUsed: 0,
    maxRenewals: 2,
    status: computeStatus(new Date("2026-06-10")),
    finePerDay: 2,
  },
  {
    id: "LB005",
    ...
    dueDateStr: "Jun 28, 2026",
    renewalsUsed: 1,
    maxRenewals: 2,
    status: computeStatus(new Date("2026-06-28")),
    finePerDay: 2,
  },
];
